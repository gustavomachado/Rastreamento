	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
																...
																<li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Delete'), array('action' => 'delete', $this->Form->value('Chip.id')), array('escape' => false), __('Are you sure you want to delete # %s?', $this->Form->value('Chip.id'))); ?></li>
		...
		<div class="col-md-9">
			<?php echo $this->Form->create('Chip', array('role' => 'form')); ?>
				...
				<div class="form-group">
					<?php echo $this->Form->input('numero_telefone', array('class' => 'form-control', 'placeholder' => 'Numero Telefone'));?>
				</div>
				<div class="form-group">
