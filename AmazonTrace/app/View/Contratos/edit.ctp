<script>
    /*$(document).ready(function () {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php //echo $this->Html->url(array('controller' => 'contratos', 'action' => 'veiculosPorClientes')) ?>",
            data: {id: id},
    ...
    function removerVeiculo(id) {
        $.ajax({
            type: 'POST',
            url: "<?php //echo $this->Html->url(array('controller' => 'contratos', 'action' => 'removerVeiculo')); ?>/" + id + "/" + $('#ContratoId').val(),
            success: function (data, textStatus, jqXHR) {
        ...
        <div>
            ...
            <div class="col-md-12" style="padding: 0px">
                ...
                <div class="form-group col-md-6">
                    <?php echo $this->Form->input('cliente_id', array('class' => 'form-control cliente', 'disabled' => 'true', 'label' => false, 'required' => 'required', 'placeholder' => 'Cliente Id', 'empty' => 'Selecione um Cliente')); ?>
                </div>
            </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody id="veiculosPorContrato">
                            <?php foreach ($veiculos as $veiculo): ?>
                                <tr>
                                    <td><?php echo $veiculo['Veiculo']['placa']; ?></td>
                                    <td><?php echo $veiculo['Veiculo']['tipo_veiculo']; ?></td>
                                    <td><?php echo $veiculo['Veiculo']['marca']; ?></td>
                                    <td><?php echo $veiculo['Veiculo']['modelo']; ?></td>
                                    <td><?php echo $veiculo['Veiculo']['ano_fabricacao']; ?></td>
                                    <td><?php echo $veiculo['Veiculo']['ano_modelo']; ?></td>
                                    <td><?php echo $veiculo['Veiculo']['status']; ?></td>
                                    <td><a href='#' onclick='removerVeiculo(<?php echo $veiculo['Veiculo']['id'] ?>)'><span class='glyphicon glyphicon-remove'></span></a></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
