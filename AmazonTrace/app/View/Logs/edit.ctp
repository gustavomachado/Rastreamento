<div class="logs form">
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
																...
																<li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Delete'), array('action' => 'delete', $this->Form->value('Log.id')), array('escape' => false), __('Are you sure you want to delete # %s?', $this->Form->value('Log.id'))); ?></li>
		...
		<div class="col-md-9">
			<?php echo $this->Form->create('Log', array('role' => 'form')); ?>
				...
				<div class="form-group">
					<?php echo $this->Form->input('acao', array('class' => 'form-control', 'placeholder' => 'Acao'));?>
				</div>
				<div class="form-group">
					<?php echo $this->Form->input('tabela', array('class' => 'form-control', 'placeholder' => 'Tabela'));?>
				</div>
				<div class="form-group">
					<?php echo $this->Form->input('dispositivo', array('class' => 'form-control', 'placeholder' => 'Dispositivo'));?>
				</div>
				<div class="form-group">
