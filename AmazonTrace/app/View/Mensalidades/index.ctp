	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Mensalidade'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			...
			<?php echo $this->Html->link($mensalidade['Contrato']['id'], array('controller' => 'contratos', 'action' => 'view', $mensalidade['Contrato']['id'])); ?>
						...
						<td><?php echo h($mensalidade['Mensalidade']['status']); ?>&nbsp;</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $mensalidade['Mensalidade']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $mensalidade['Mensalidade']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $mensalidade['Mensalidade']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $mensalidade['Mensalidade']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
