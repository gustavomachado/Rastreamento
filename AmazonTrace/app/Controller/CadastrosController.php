...
class CadastrosController extends AppController {
    ...
    public function beforeFilter() {
        ...
        $paginas_permitidas = $this->Pagina->find('all', array('fields' => array('nome', 'url', 'class_icon'), 'conditions' => array('id' => $acessos, "url not in ('Acessos','Contratos', 'Paginas', 'Logs', 'Veiculos', 'Contatos', 'Mensalidades')")));
