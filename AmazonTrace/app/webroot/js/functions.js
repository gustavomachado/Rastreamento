$(document).ready(function () {
    ...
    if (typeof ($(".table-center")) !== undefined) {
        var botao = $(".table-center");
        botao.click(function () {
            var alinhaMento;
            var span = $(this).find(".glyphicon");
            if ($(this).hasClass("active")) {
                $(this).removeClass("active").html("");
                span.removeClass("glyphicon-align-left").addClass("glyphicon-align-center");
                $(this).append(span[0]);
                $(this).html($(this).html()+"Centralizar");
                alinhaMento = "left";
            } else {
                $(this).addClass("active").html("");
                span.removeClass("glyphicon-align-center").addClass("glyphicon-align-left");
                $(this).append(span[0]);
                $(this).html($(this).html()+"à Esquerda");
                alinhaMento = "center";
            }
            var tabela = $(".table-center").attr("data-target");
            console.log("clicou " + tabela);
            $(tabela + " th," + tabela + " td ").each(function () {
                $(this).attr("align", alinhaMento);
                $(this).css("text-align", alinhaMento);
            });
        });
    }
